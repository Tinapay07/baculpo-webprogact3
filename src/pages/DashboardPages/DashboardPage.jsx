  ...
  return (
    <Stack spacing={2.5}>
      ...
      <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1.5 }}>
        {summaryCards.map((card) => (
          ...
          >
            <Paper
              elevation={0}
              sx={{ border: "1px solid #e5e7eb", p: 1.25, height: "100%" }}
            >
              ...
              <Typography
                variant="h6"
                sx={{ mt: 0.5, color: "#111827", fontWeight: 700 }}
              >
                {card.value}
              </Typography>
            </Paper>
      ...
      <Box>
        ...
        <Paper
          elevation={0}
          sx={{ border: "1px solid #e5e7eb", width: "100%" }}
        >
      ...
      <Box>
        ...
        >
          <Box sx={{ height: { xs: 340, md: 500 }, width: "100%" }}>
            <MapContainer
